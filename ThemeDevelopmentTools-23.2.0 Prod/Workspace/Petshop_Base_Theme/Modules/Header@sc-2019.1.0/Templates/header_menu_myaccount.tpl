...
<ul class="header-menu-myaccount">
 ...
 <li class="header-menu-myaccount-item-level2">
  <a class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#subscription-orders" name="bottomlessbowl">
			{{translate 'Bottomless Bowl'}}
		</a>
  
		<ul class="header-menu-myaccount-level3">
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#subscription-orders" name="bottomlessbowl">{{translate 'Your Bottomless Bowl'}}</a>
			</li>
		</ul>
	</li>

 <li class="header-menu-myaccount-item-level2">
		<a  class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-action="push-menu" name="pets">
			{{translate 'Pets'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</a>
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#pets" name="allmypets">{{translate 'Your Pets'}}</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#pets/new" name="addapet">{{translate 'Add a New Pet'}}</a>
			</li>
		</ul>
	</li>
	...
	<li class="header-menu-myaccount-item-level2" data-permissions="lists.listCase.2">
		...
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#cases" name="allmycases">{{translate 'Your Support Cases'}}</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#newcase" name="submitnewcase">{{translate 'Submit a New Case'}}</a>
			</li>
		</ul>
	</li>
	{{/if}}
 ...
 <li class="header-menu-myaccount-item-level2">
  <a class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#returns" name="returns">
			{{translate 'Returns'}}
		</a>
  
		<ul class="header-menu-myaccount-level3">
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#returns" data-permissions="{{returnsPermissions}}" name="returns">{{translate 'Your Returns'}}</a>
			</li>
		</ul>
	</li>
