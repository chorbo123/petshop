...
<div class="header-login-wrapper">
	<div class="hlw-flex">
		<p>Log in to see our best deals</p>
		<a href="#" data-touchpoint="login" data-hashtag="login-register" class="header-login">Log in</a>
		<!-- <button class="header-login">Log in</button> -->
		<a href="#" data-touchpoint="login" data-hashtag="login-register" class="header-register">Register</a>
		<div class="login-close"></div>
	</div>
</div>

<div class="header-main-wrapper header-2020">
		...
		<div class="header-content">
			...
			<div class="header-right-menu">
				...
				<div class="header-help">
					...
					<span>{{translate '01789 205 095'}} &nbsp;|&nbsp; <a href="/contact">Contact Us</a></span>
				</div>
			...
			<div class="header-bottom-menu">
				...
				<div class="header-menu-nav" data-view="Header.Menu" data-phone-template="header_sidebar"
