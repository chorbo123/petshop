...
<section class="case-new">
	...
	<form action="#" class="case-new-form" novalidate>
		...
		<div class="case-new-form-controls-group" data-validation="control-group">
			<label class="case-new-form-label" for="salesorder">
				{{translate 'What order does this query relate to?'}}
			</label>

			<div class="case-new-form-controls" data-validation="control">
				<select name="salesorder" id="salesorder" class="case-new-form-case-salesorder">
     <option value=""></option>
					{{#each salesorders}}
						<option value="{{id}}"{{#if @first}} selected{{/if}}>
							{{text}}
						</option>
					{{/each}}
				</select>
