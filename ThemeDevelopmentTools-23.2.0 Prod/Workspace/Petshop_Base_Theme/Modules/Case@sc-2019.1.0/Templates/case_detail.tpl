	...
	<div class="case-detail-header-information">
		<div class="case-detail-header-row">
			<div class="case-detail-header-col-left">
				...
				<p>{{translate '<span class="case-detail-label-salesorder">What order does this query relate to?: </span> <span class="case-detail-value-salesorder">$(0)</span>' model.salesorder.name}}</p>
