 ...
 <meta itemprop="sku" content="{{sku}}"/>
	...
	<div class="facets-item-cell-list-left">
		<div class="facets-item-cell-list-image-wrapper">
			...
			{{/if}}
   {{#if isFreeDelivery}}
    <span class="facets-item-cell-list-image-free-delivery"></span>
   {{/if}}
   {{#if isOnSale}}
    <span class="facets-item-cell-list-image-sale"></span>
   {{/if}}
   {{#if productTypeImageUrl}}
    <span class="facets-item-cell-list-image-product-type" style="background-image: url({{productTypeImageUrl}});"></span>
   {{/if}}
   {{#if expressDelivery.nextDayAvailable}}
    <span class="facets-item-cell-list-image-next-day-delivery"></span>
   {{/if}}
