	...
	{{#if showResults}}
		<div class="facets-facet-browse-content">
			...
			<div class="facets-facet-browse-facets" data-action="pushable" data-id="product-search-facets">
				...
				<div data-view="Facets.FacetedNavigation" data-exclude-facets="commercecategoryname,category,custitem_bb1_web_showinsearchresults,custitem_bb1_cop_currentpromotions,quantityavailable,custitem_bb1_supplier_stock,custitem_bb1_web_freeitem,custitem_bb1_web_animaltype,custitem_bb1_loyaltyitem"></div>
