	...
	)
{
	...
	// @class bb1.Blog.Posts.ListCell.View @extends Backbone.View
	return Backbone.View.extend({

		// @property {Function} template
		template: bb1_blog_posts_list_cell_tpl,
		...
		// @method getContext @return bb1.Blog.Posts.ListCell.View.Context
		getContext: function ()
		{
			// @class bb1.Blog.Posts.ListCell.View
   var post = this.model,
