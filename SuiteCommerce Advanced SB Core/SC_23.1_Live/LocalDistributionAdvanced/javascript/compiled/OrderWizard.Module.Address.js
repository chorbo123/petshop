...
*/
define("OrderWizard.Module.Address", ["require", "exports", "underscore", "order_wizard_address_module.tpl", "order_wizard_address_row.tpl", "order_wizard_address_cell.tpl", "paymentinstrument_creditcard_edit.tpl", "Utils", "jQuery", "Address.Model", "Wizard.StepModule", "Address.Details.View", "Address.Edit.View", "GlobalViews.Confirmation.View", "Backbone", "Backbone.CollectionView"], function (require, exports, _, order_wizard_address_module_tpl, order_wizard_address_row_tpl, order_wizard_address_cell_tpl, paymentinstrument_creditcard_edit_tpl, Utils, jQuery, Address_Model_1, Wizard_StepModule_1, Address_Details_View_1, AddressEditView, GlobalViewsConfirmationView, Backbone, BackboneCollectionView) {
    "use strict";
    // @class OrderWizard.Module.Address @extend Wizard.Module
    var OrderWizardModuleAddress = Wizard_StepModule_1.WizardStepModule.extend({
        ...
        editAddress: function (e) {
            ...
            if (_.isNaN(address_id) || !_.isNumber(address_id)) {
                ...
                view_1.once('modal-close', function () {
        ...
        evaluateDisablingSameAsCheckBox: function (reRenderIsChange) {
            // The other manage address is not selected AND the other temp address is not created
            var oldValue = this.disableSameAsCheckBox;
        ...
        validateAddressRemoval: function (address_id // address_module
            ...
            if (this.isAddressIdValidForRemoval(address_id)) {
                ...
                var other_address_message = this.sameAsManage === 'billaddress'
                    ? Utils.translate('(billing address)')
                    : this.sameAsManage === 'shipaddress'
                        ? Utils.translate('(shipping address)')
                        : '';
                body = Utils.translate('The selected address is in use. $(0) Are you sure you want to delete this address?', other_address_message);
            }
        ...
        evaluateSameAs: function () {
            ...
            var other_address = this.getTheOtherAddress();
            var other_address_id = (other_address && other_address.get('internalid')) || null;
        ...
        eventHandlersOn: function () {
            var self = this;
            var other_address = this.sameAsManage;
            this.eventHandlersOff();
            this.addresses
                // Adds events to the collection
                .on('add', function (added_address) {
                this.address = added_address;
                this.addressId = added_address.get('internalid');
                this.render(true);
            }, this)
                .on('reset sync remove change destroy', function () {
                this.render(true);
            }, this)
        ...
        selectAddress: function (e) {
            ...
            this.setAddress(jQuery(e.target)
                .data('id')
                .toString());
        ...
        changeAddressHandler: function (e) {
            ...
            var is_disabled = $link.attr('disabled');
        ...
        submit: function () {
            ...
            if (this.addressView) {
                ...
                var result = this.addressView.saveForm(fake_event);
        ...
        checkSelectedAddress: function (selectedAddress) {
            if (selectedAddress) {
                if (selectedAddress.get('isvalid') === 'T') {
                    return jQuery.Deferred().resolve();
                }
        ...
        isValid: function () {
            ...
            return this.checkSelectedAddress(selected_address);
        },
        ...
        getSelectedAddress: function () {
            if (!this.addressId) {
                if (this.sameAs && this.tempAddress) {
                    return new Address_Model_1.AddressModel(this.tempAddress);
                }
            }
            ...
            var address = this.addresses.get(this.addressId);
            if (!address) {
                var defaultManage_1 = this.manage === 'billaddress' ? 'defaultbilling' : 'defaultshipping';
                address = _.find(this.addresses.models, function (currentAddress) {
                    return currentAddress.get(defaultManage_1) === 'T';
                });
                if (address) {
        ...
        getEmptyAddress: function () {
            return new Address_Model_1.AddressModel(this.isSameAsEnabled && this.sameAs ? null : this.model.get("temp" + this.manage));
        },
        ...
        manageError: function (error) {
            if (error && error.errorCode !== 'ERR_CHK_INCOMPLETE_ADDRESS') {
                Wizard_StepModule_1.WizardStepModule.prototype.manageError.apply(this, arguments);
            }
        },
        ...
        prepopulateAddressModel: function () {
            if (this.wizard.options.profile.get('isperson') &&
        ...
        getContext: function () {
            ...
            return {
                ...
                showSingleAddressDetails: !!(this.address &&
...
//# sourceMappingURL=OrderWizard.Module.Address.js.map
