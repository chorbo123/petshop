...
*/
define("OrderWizard.Module.Shipmethod", ["require", "exports", "underscore", "order_wizard_shipmethod_module.tpl", "Utils", "jQuery", "Wizard.StepModule", "GlobalViews.Message.View", "Profile.Model", "Tracker"], function (require, exports, _, order_wizard_shipmethod_module_tpl, Utils, jQuery, Wizard_StepModule_1, GlobalViews_Message_View_1, Profile_Model_1, Tracker) {
    "use strict";
    return Wizard_StepModule_1.WizardStepModule.extend({
        ...
        changeDeliveryOptions: function changeDeliveryOptions(e) {
            ...
            this.model.setShipMethod(targetValue).always(function () {
                _this.clearError();
