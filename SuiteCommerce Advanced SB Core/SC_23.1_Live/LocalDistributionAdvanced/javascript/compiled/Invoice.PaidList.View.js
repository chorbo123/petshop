...
*/
define("Invoice.PaidList.View", ["require", "exports", "underscore", "invoice_paid_list.tpl", "Utils", "jQuery", "Configuration", "ListHeader.View", "RecordViews.View", "GlobalViews.Pagination.View", "AjaxRequestsKiller", "Transaction.List.View", "Invoice.Collection", "Backbone.CollectionView", "Handlebars", "Backbone", "Backbone.CompositeView"], function (require, exports, _, invoice_paid_list_tpl, Utils, jQuery, Configuration_1, ListHeader_View_1, RecordViews_View_1, GlobalViews_Pagination_View_1, AjaxRequestsKiller_1, TransactionListView, InvoiceCollection, BackboneCollectionView, Handlebars, Backbone) {
    "use strict";
    ...
    var InvoicePaidListView = TransactionListView.extend({
        ...
        initialize: function (options) {
            ...
            this.collection = new InvoiceCollection([], { status: 'paid' });
