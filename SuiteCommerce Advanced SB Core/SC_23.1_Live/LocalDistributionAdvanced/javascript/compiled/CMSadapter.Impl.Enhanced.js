...
*/
define("CMSadapter.Impl.Enhanced", ["require", "exports", "underscore", "Utils", "jQuery"], function (require, exports, _, Utils, jQuery) {
    "use strict";
    /*
    ...
    */
    function AdapterEnhanced(application, router) {
        ...
        var show_content_wrapper = function (fn, view) {
            ...
            if (!view.externalLinkInModal) {
                var pageTypeComponent = application.getComponent('PageType');
                var pageContext = pageTypeComponent.getContext();
                var pageType = pageTypeComponent._getPageType(pageContext.page_type);
                var pageTypeTemplate = pageType && pageType.get('template');
                var pageTemplate = String((page && page.get('template')) || '').trim();
                var templateKey = (pageTemplate !== 'default' && pageTemplate) || pageTypeTemplate || '';
                if (templateKey) {
                    var template = void 0;
                    try {
    ...
    _.extend(AdapterEnhanced.prototype, {
        enhancePage: function (view, _layout, page) {
            ...
            view.setMetaDescription((page && page.get('meta_description')) || view.getMetaDescription());
...
//# sourceMappingURL=CMSadapter.Impl.Enhanced.js.map
