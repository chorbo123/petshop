...
define("Tracker", ["require", "exports", "underscore", "Utils", "jQuery", "Tracker.ExtensibilityHelper", "Backbone", "Singleton"], function (require, exports, _, Utils, jQuery, Tracker_ExtensibilityHelper_1, Backbone, Singleton) {
    ...
    Tracker.prototype.trackAddShippingInfo = function (_a) {
        var shipmethods = _a.shipmethods, cart = _a.cart, trackOnlyIfFirstTime = _a.trackOnlyIfFirstTime;
        if (!trackOnlyIfFirstTime || !this.trackOnlyIfFirstTime.addShippingInfo) {
            this.trackOnlyIfFirstTime.addShippingInfo = true;
            this.track('trackAddShippingInfo', { shipmethods: shipmethods, cart: cart });
        }
        return this;
    };
    Tracker.prototype.trackRefund = function (_a) {
        var requestReturn = _a.requestReturn;
        return this.track('trackRefund', { requestReturn: requestReturn });
    };
    ...
    Tracker.prototype.trackAddPaymentInfo = function (_a) {
        var cart = _a.cart, paymentType = _a.paymentType, trackOnlyIfFirstTime = _a.trackOnlyIfFirstTime;
