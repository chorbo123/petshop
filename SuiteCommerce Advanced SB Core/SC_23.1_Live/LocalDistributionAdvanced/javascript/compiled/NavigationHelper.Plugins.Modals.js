...
*/
define("NavigationHelper.Plugins.Modals", ["require", "exports", "underscore", "Utils", "jQuery", "Backbone.View", "Backbone", "UrlHelper"], function (require, exports, _, Utils, jQuery, BackboneView, Backbone) {
    "use strict";
    ...
    var modalsPlugin = {
        ...
        showInternalLinkInModal: function (e, href, $target, layout) {
            ...
            layout.showContent = function (view) {
                return layout
                    ...
                    .then(function () { return _showContent(view); })
                    .fail(function () {
        ...
        clickNavigation: function (layout, e, application) {
            ...
            var href = layout.getUrl(context) || '';
            var target_is_blank = layout.isTargetBlank(e) || e.button === 1;
            var target_is_modal = context.target_data.toggle === 'show-in-modal';
            var is_disabled = context.$target.attr('disabled');
            var is_dropdown = context.target_data.toggle === 'dropdown';
            var is_external;
            if (is_disabled) {
                e.stopPropagation();
                return e;
...
//# sourceMappingURL=NavigationHelper.Plugins.Modals.js.map
