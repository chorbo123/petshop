...
*/
define("GlobalViews.FormatPaymentMethod.View", ["require", "exports", "underscore", "global_views_format_payment_method.tpl", "Utils", "Configuration", "Backbone.View", "Backbone.Model"], function (require, exports, _, global_views_format_payment_method_tpl, Utils, Configuration_1, BackboneView, BackboneModel) {
    "use strict";
    ...
    var GlobalViewsFormatPaymentMethodView = BackboneView.extend({
        ...
        getContext: function () {
            ...
            var is_ach = (internal &&
                ...
                internal.paymentmethod.automatedclearinghouse === 'T') ||
                this.model.get('type') === 'ach';
            var account;
            var limit;
            if (is_ach) {
