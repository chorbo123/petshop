...
define('jQuery.scPush', ['jQuery', 'underscore', 'Utils'], function (jQuery, _, Utils) {
    jQuery.fn.scPush = function (options) {
        ...
        var opened_pusher = jQuery("[data-id=\"" + opened_pusher_id + "\"]");
        ...
        return this.each(function () {
            ...
            var $push_header = $this.find('.sc-pusher-header, [data-type="sc-pusher-header"]');
            if (!$push_header.length) {
                // add push header containing back button
                $push_header = jQuery("<div class=\"sc-pusher-header\">\n\t\t\t\t\t\t<a href=\"#\" class=\"sc-pusher-header-back\" data-action=\"sc-pusher-dismiss\">\n\t\t\t\t\t\t\t" + Utils.translate('Back', 'Return to the previews menu') + "\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>");
    ...
    function setOverlay() {
        if (Utils.getViewportWidth() >= 768) {
            var $main_1 = jQuery('.layout-container');
            var overlay = jQuery('<div class="main-push-overlay" data-action="main-push-overlay-hide"></div>');
            $main_1.find('.main-push-overlay').remove();
            $main_1.append(overlay);
            overlay.on('click', function () {
                ...
                $main_1.removeClass('sc-pushing');
                jQuery('[data-view="Footer"]').show();
                $main_1.css({ 'margin-top': '', height: '' }).removeClass('sc-pushing-partial');
...
//# sourceMappingURL=jQuery.scPush.js.map
