(function(root) {define("jQuery.bxSlider", ["jQuery"], function() {
                return (function() {/**
 * bxSlider v4.2.1d
...
(function ($) {
    ...
    $.fn.bxSlider = function (options) {
        ...
        var tickerLoop = function (resumeSpeed) {
            var speed = resumeSpeed ? resumeSpeed : slider.settings.speed, position = { left: 0, top: 0 }, reset = { left: 0, top: 0 }, animateProperty, resetValue, params;
      ...
      doesn't fire after a touchstart (this happens on windows phones only) */
        ...
        var onTouchMove = function (e) {
            ...
            // this is swipe
            slider.hasMove = !!(xMovement || yMovement);
            // x axis swipe
        ...
        var onTouchEnd = function (e) {
            ...
            if (slider.hasMove === false && (slider.originalClickButton === 0 || slider.originalEventType === 'touchstart')) {
                ...
                $(slider.originalClickTarget).closest("a").trigger({
                    type: 'click',
        ...
        el.goToSlide = function (slideIndex, direction) {
            ...
            var performTransition = true, moveBy = 0, position = { left: 0, top: 0 }, lastChild = null, lastShowingIndex, eq, value, requestEl;
            // store the old index
