...
*/
define("ItemsSearcher.View", ["require", "exports", "underscore", "itemssearcher.tpl", "Utils", "jQuery", "ItemsSearcher.Utils", "ItemsSearcher.Collection", "ItemsSearcher.Item.View", "PluginContainer", "Backbone.View", "Tracker", "typeahead"], function (require, exports, _, itemssearcher_tpl, Utils, jQuery, ItemsSearcherUtils, ItemsSearcherCollection, ItemsSearcherItemView, PluginContainer, BackboneView, Tracker) {
    "use strict";
    // @class ItemsSearcher.View @extends Backbone.View
    var ItemsSearcherView = BackboneView.extend({
        ...
        configureTypeahead: function () {
            ...
            if (SC.ENVIRONMENT.jsEnvironment !== 'server') {
                ...
                // TYPE AHEAD HACKS
                var drop_1 = self.$searchElement.data('ttTypeahead').menu;
                drop_1.$node.off('click.tt', '.tt-suggestion').on('click.tt', '.tt-suggestion', _.bind(function ($e) {
                    $e.preventDefault();
                    $e.stopPropagation();
                    drop_1.trigger('suggestionClicked', jQuery($e.currentTarget));
                }, drop_1));
        ...
        selectFirstIfRequire: function selectFirstIfRequire() {
            if (this.options.highlightFirst) {
                var $menu_container = this.$searchElement.data('ttTypeahead').menu;
                var current_cursor_index = $menu_container.find('.tt-suggestion.tt-cursor').index();
...
//# sourceMappingURL=ItemsSearcher.View.js.map
