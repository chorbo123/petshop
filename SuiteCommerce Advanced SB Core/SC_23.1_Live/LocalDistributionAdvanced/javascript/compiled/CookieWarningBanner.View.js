...
*/
define("CookieWarningBanner.View", ["require", "exports", "cookie_warning_banner_view.tpl", "Configuration", "Utils", "Backbone.View", "js.cookie"], function (require, exports, cookie_warning_banner_view_tpl, Configuration_1, Utils, BackboneView, Cookies) {
    "use strict";
    ...
    var CookieWarningBannerView = BackboneView.extend({
        ...
        getContext: function getContext() {
            ...
            return {
                ...
                cookieMessage: Utils.translate(Configuration_1.Configuration.get('cookieWarningBanner.message', '')),
                ...
                linkContent: Utils.translate(Configuration_1.Configuration.get('cookieWarningBanner.anchorText', '')),
                // @property {Boolean} showLink
