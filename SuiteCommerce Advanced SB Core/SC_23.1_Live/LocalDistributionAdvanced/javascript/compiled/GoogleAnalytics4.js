...
*/
define("GoogleAnalytics4", ["require", "exports", "underscore", "Utils", "jQuery", "Configuration", "Tracker", "Backbone"], function (require, exports, _, Utils, jQuery, Configuration_1, Tracker, Backbone) {
    "use strict";
        ...
        var GoogleAnalytics4 = {
            ...
            trackTransaction: function (transaction) {
                ...
                var purchase = {
                    ...
                    affiliation: Configuration_1.Configuration.get('siteSettings.displayname'),
                    items: []
                };
            ...
            loadScript: function (id) {
                return jQuery.getScript("//www.googletagmanager.com/gtag/js?id=" + id + "&l=" + dataLayerName);
            },
            // @method mountToApp
            // @param {ApplicationSkeleton} application
            // @return {Void}
            mountToApp: function (application) {
                var tracking = Configuration_1.Configuration.get('tracking.googleAnalyticsFour');
