...
*/
define("jQuery.sidebarMenu", ["require", "exports", "jQuery"], function (require, exports, jQuery) {
    "use strict";
    function Menu(el) {
        var parent = el.parent();
        var wrapper = el;
        var last_opened_menu = wrapper;
        var root_ul = wrapper.find('.header-sidebar-menu:first');
        var animating = false;
        var has_animation_support = detectAnimationSupport();
        var class_names = {
        ...
        jQuery(root_ul).on('click', '[data-action="push-menu"]', function (e) {
            ...
            var parent_li = anchor.closest('li');
            var pushing_menu = anchor.next();
        ...
        jQuery(root_ul).on('click', '[data-action="pop-menu"]', function (e) {
            ...
            var anchor_menu = anchor.closest('ul');
            var opened_li = anchor.closest('.' + class_names.menuOpened);
    ...
    function addTrapFocusListener(element) {
        var focusableElements = jQuery(element).find('a[href]:not([disabled]):not([aria-disabled]), button:not([disabled]):not([aria-disabled]), textarea:not([disabled]):not([aria-disabled]), input:not([disabled]):not([aria-disabled]), select:not([disabled]):not([aria-disabled])');
...
//# sourceMappingURL=jQuery.sidebarMenu.js.map
