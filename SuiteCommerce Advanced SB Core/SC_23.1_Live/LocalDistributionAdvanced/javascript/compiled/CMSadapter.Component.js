        ...
        var CMSAdapterComponent = SC_BaseComponent_1.SCBaseComponent.extend({
            ...
            _installContent: function _installContent(cct, cct_settings, context_data) {
                ...
                return jQuery.when(cct.install(cct_settings, context_data)).then(function () {
                    ...
                    var message = (e && _.isFunction(e.toString) && e.toString()) ||
                        Utils.translate('Unknown error installing CCT. CCT Instance Id: $(0)', cct.instanceId, 'Error when there is an unexpected error when installing the CCT with that instance Id');
                    return jQuery
                        .Deferred()
            ...
            _updateSettings: function _updateSettings(cctContainer, cct_settings) {
                ...
                return jQuery.when(cct.update(cct_settings)).then(function () {
                    ...
                    var message = (e && _.isFunction(e.toString) && e.toString()) ||
                        Utils.translate('Unknown error updating CCT. CCT Instance Id: $(0)', cct.instanceId, 'Error when there is an unexpected error when installing the CCT with that instance Id');
            ...
            addContent: function addContent(cctId, cctInstanceId, cctSelector, cctSettings, renderSettings) {
                ...
                if (rawCCTs) {
                    if (!rawCCTs[cctInstanceId]) {
                        ...
                        return jQuery
                            .Deferred()
                            .reject(this._createError('ERR_INVALID_INSTANCE_ID', Utils.translate('Invalid content type instance id: $(0), already exists', cctInstanceId, 'Error when adding a CCT because already exists one with that instance id')));
                    }
                }
                else {
                    if (!customContentTypesViews[cctInstanceId]) {
                        ...
                        var cctGenerator_1 = {
                            ...
                            cctErrorContextNotFound: this._createError('ERR_CONTEXTNOTFOUND_CCT', Utils.translate('Context for CCT not found. CCT Instance Id: $(0)', cctInstanceId, "Error when a CCT with that instance id doesn't have context"))
                        };
                        ...
                        _.each(container.views, function (parentViewInstance) {
                            if (!_this.application.getLayout().getCurrentView().inModal ||
                                parentViewInstance.inModal) {
            ...
            updateContent: function updateContent(cctId, cctInstanceId, cctSelector, cctSettings, renderSettings) {
                ...
                if (rawCCTs) {
                    if (rawCCTs[cctInstanceId]) {
                        ...
                        return jQuery
                            .Deferred()
                            .reject(this._createError('ERR_INVALID_INSTANCE_ID', Utils.translate('Invalid content type instance id: $(0), does not exists', cctInstanceId, "Error when doesn't exist a CCT with that instance id")));
                    }
                }
                else {
                    var self_1 = this;
                    ...
                    return jQuery
                        .Deferred()
                        .reject(self_1._createError('ERR_INVALID_INSTANCE_ID', Utils.translate('Invalid content type instance id: $(0), does not exists', cctInstanceId, "Error when doesn't exist a CCT with that instance id")));
                }
            },
            ...
            removeContent: function removeContent(cctInstanceId, destroyCall) {
                ...
                if (rawCCTs) {
                    if (rawCCTs[cctInstanceId]) {
                        ...
                        return jQuery
                            .Deferred()
                            .reject(this._createError('ERR_INVALID_INSTANCE_ID', Utils.translate('The specified instance id is not registered. Instance Id: $(0)', cctInstanceId, "Error when a CCT with that instance id doesn't exists")));
                    }
                }
                else {
