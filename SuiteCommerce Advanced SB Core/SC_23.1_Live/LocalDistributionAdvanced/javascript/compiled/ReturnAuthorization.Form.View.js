...
*/
define("ReturnAuthorization.Form.View", ["require", "exports", "underscore", "return_authorization_form.tpl", "Utils", "jQuery", "Configuration", "ListHeader.View", "AjaxRequestsKiller", "Transaction.Line.Views.Cell.Navigable.View", "Transaction.Line.Collection", "ReturnAuthorization.GetReturnableLines", "Backbone.CollectionView", "Transaction.Line.Views.Cell.SelectableActionableNavigable.View", "ReturnAuthorization.Form.Item.Summary.View", "ReturnAuthorization.Form.Item.Actions.View", "ReturnAuthorization.Model", "OrderHistory.Model", "Backbone", "Backbone.View", "Tracker"], function (require, exports, _, return_authorization_form_tpl, Utils, jQuery, Configuration_1, ListHeader_View_1, AjaxRequestsKiller_1, Transaction_Line_Views_Cell_Navigable_View_1, TransactionLineCollection, ReturnLinesCalculator, BackboneCollectionView, TransactionLineViewsCellSelectableActionableNavigableView, ReturnAuthorizationFormItemSummaryView, ReturnAuthorizationFormItemActionsView, ReturnAuthorizationModel, OrderHistoryModel, Backbone, BackboneView, Tracker) {
    "use strict";
    ...
    exports.ReturnAuthorizationFormView = BackboneView.extend({
        ...
        saveForm: function (e) {
            ...
            if (this.isValid(data)) {
                return BackboneView.prototype.saveForm
                    .call(this, e, this.model, data)
                    .done(function (requestReturn) {
