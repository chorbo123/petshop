...
define('ExternalPayment.Model', [
    ...
    return SCModel.extend({
        ...
        _isDone: function(request, record_type) {
            ...
            const status_success_value = this._getConfiguration(
                record_type,
                'statusSuccessValue',
                'SUCCESS'
            );
        ...
        _isReject: function(request, record_type) {
            ...
            const status_fail_value = this._getConfiguration(
                record_type,
                'statusFailValue',
                'FAIL'
            );

            return status === status_reject_value || status === status_fail_value;
        },
        ...
        _getStatusFromRequest: function(request, record_type) {
            ...
            return request.getParameter(
                this._getConfiguration(record_type, 'statusParameterName', default_status)
            );
        },
