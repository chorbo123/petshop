...
export = BackboneView.extend({
    ...
    events: {
        ...
        'focus [data-toggle="categories-menu"]': 'menuOpen',
        'mouseleave [data-toggle="categories-menu"]': 'menuClose',
        'blur [data-toggle="categories-menu"]': 'menuCloseOnBlur',
        'click [data-toggle="categories-menu"]': 'menuClose'
    },

    menuOpen: function(e) {
        jQuery(e.currentTarget).addClass('open');
        jQuery(e.currentTarget.firstChild).attr('aria-expanded', 'true');
    },

    menuClose: function(e) {
        jQuery(e.currentTarget).removeClass('open');
        jQuery(e.currentTarget.firstChild).attr('aria-expanded', 'false');
    },

    menuCloseOnBlur: function(e) {
