...
export = BackboneView.extend({
    ...
    showSidebar: function(): void {
        ...
        jQuery('button.header-sidebar-toggle')
            .attr('aria-expanded', 'true')
            .attr('data-action', 'header-sidebar-hide');
        jQuery('.header-sidebar-wrapper')
            .addClass('header-sidebar-wrapper-visible')
            .trigger('focus');
    },
    ...
    hideSidebar: function(e): void {
        ...
        jQuery('button.header-sidebar-toggle')
            ...
            .attr('data-action', 'header-sidebar-show')
            .trigger('focus');
        jQuery('.header-sidebar-wrapper').removeClass('header-sidebar-wrapper-visible');
    },

    hideSidebarOnEsc: function(e): void {
        if (e.key === 'Escape') {
            this.hideSidebar(e);
        }
    },
