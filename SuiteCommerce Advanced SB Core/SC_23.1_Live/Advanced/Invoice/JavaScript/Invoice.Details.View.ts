...
const InvoiceDetailsView: any = BackboneView.extend({
    ...
    makeAPayment: function(): void {
        LivePaymentModel.getInstance().makeAPayment([this.model]);
    },
    ...
    getContext: function() {
        ...
        const paymentStatusUnapproved =
            this.model.get('payment') && this.model.get('payment').status === 'unapprovedPayment';
        ...
        return {
            ...
            // @property {Boolean}
            showMakeAPaymentButton: !!(is_open && !this.inModal && !paymentStatusUnapproved),
