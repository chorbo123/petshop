...
export = BackboneView.extend({
    ...
    handleSliderKeydown: function(e): void {
        const targetControl: string = e.target.getAttribute('data-control');
        const slider = this.sliders.data('slider');
        const sliderMinimumValueThumbName = 'low';
    ...
    adjustSliderLowValue: function(slider, value): void {
    ...
    adjustSliderHighValue: function(slider, value): void {
    ...
    handleSliderKeyup: function(e): void {
        const slider = this.sliders.data('slider');
