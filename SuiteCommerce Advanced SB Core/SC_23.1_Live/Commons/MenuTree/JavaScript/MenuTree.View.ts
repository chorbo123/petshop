...
export = BackboneView.extend(
    {
        ...
        menuClick: function(e, synthetic) {
            ...
            all_expandables.removeClass('open').attr('aria-expanded', 'false');
            this_expandable.addClass('open').attr('aria-expanded', 'true');
            ...
            if (synthetic === undefined && this_expander_is_opened) {
                ...
                this_expandable.removeClass('open').attr('aria-expanded', 'false');
            }
        },
