...
export const ProfileModel: any = Backbone.Model.extend(
    {
        ...
        initialize: function initialize(attributes) {
            ...
            this.set(
                'paymentmethodsach',
                (attributes && attributes.paymentmethodsach) || new PaymentInstrumentACHCollection()
            );
            this.on('change:paymentmethodsach', function(model, paymentMethodsACH) {
                ...
                if (
                    Configuration.get('checkoutApp.isAchEnabledInCheckout') ||
                    Configuration.get('paymentInstrumentACHEnabled')
                ) {
                    const paymentInstrumentACHCollection = new PaymentInstrumentACHCollection();
        ...
        getSearchApiUrl: function(): string {
            ...
            if (Configuration.get('isNewSearchApiEnabled') === true) {
