...
define(
  ...
  function (
    ...
    if (Configuration.get('personalisedCustomerViews.enabled')) {
      ...
      CMSadapterImplCategories3.CMSadapterImplCategories3.prototype.changeServices = _.wrap(CMSadapterImplCategories3.CMSadapterImplCategories3.prototype.changeServices, function (originalChangeServices) {
      ...
      CMSadapterImplCategories3.CMSadapterImplCategories3.prototype.listenForCMS = _.wrap(CMSadapterImplCategories3.CMSadapterImplCategories3.prototype.listenForCMS, function (originalListenForCMS) {
      ...
      CMSadapterImplCategories3.CMSadapterImplCategories3.prototype.categoriesRefresh = function (menu) {
      ...
      Categories.mountToApp = _.wrap(Categories.mountToApp, function (originalMountToApp, application) {
        ...
        if (Configuration.get('categories')) {
          ...
          if (SC.ENVIRONMENT.siteSettings.isPersonalizedCatalogViewsEnabled && !ProfileModel.getInstance().isAnnonymous()) {
            var categoriesFetch = new CategoriesCollection.CategoriesCollection({
              level: Configuration.get('categories.menuLevel'),
              preventDefault: true
            }).fetch();

            console.log('config', categoriesFetch)
